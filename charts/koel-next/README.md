...
![Version: 1.4.1](https://img.shields.io/badge/Version-1.4.1-informational?style=flat-square) ![AppVersion: v9.11.0](https://img.shields.io/badge/AppVersion-v9.11.0-informational?style=flat-square)
...
| koel.persistence.frameworkCache.accessMode | string | `"ReadWriteOnce"` |  |
| koel.persistence.frameworkCache.enabled | bool | `true` |  |
| koel.persistence.frameworkCache.size | string | `"10Gi"` |  |
| koel.persistence.frameworkCache.storageClass | string | `""` |  |
