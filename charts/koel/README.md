...
![Version: 0.2.3](https://img.shields.io/badge/Version-0.2.3-informational?style=flat-square) ![AppVersion: v6.11.5](https://img.shields.io/badge/AppVersion-v6.11.5-informational?style=flat-square)
...
| images.koel.tag | string | `"v6.11.5"` |  |
