...
![Version: 0.2.2](https://img.shields.io/badge/Version-0.2.2-informational?style=flat-square) ![AppVersion: v6.11.3](https://img.shields.io/badge/AppVersion-v6.11.3-informational?style=flat-square)
...
| images.koel.tag | string | `"v6.11.3"` |  |
