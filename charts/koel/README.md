...
![Version: 0.2.4](https://img.shields.io/badge/Version-0.2.4-informational?style=flat-square) ![AppVersion: v6.12.0](https://img.shields.io/badge/AppVersion-v6.12.0-informational?style=flat-square)
...
| images.koel.tag | string | `"v6.12.0"` |  |
