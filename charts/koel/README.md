...
![Version: 0.2.1](https://img.shields.io/badge/Version-0.2.1-informational?style=flat-square) ![AppVersion: v6.11.2](https://img.shields.io/badge/AppVersion-v6.11.2-informational?style=flat-square)
...
| images.koel.tag | string | `"v6.11.2"` |  |
